...
const Profile = () => {
  ...
  const handleFileUpload = (file) => {
    ...
    const user = JSON.parse(localStorage.getItem("getUserData"));
    if (user) {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      const res = await fetch(`${GetSrcBE}/api/user/me`, {
        headers: {
          ...
          <section className="px-6 py-8 space-y-8">
            ...
            <div className="space-y-5">
              ...
              <div
                ...
                style={{ boxShadow: "2px 3px 5px inset" }}
              >
                {plan ? 50 - numberOfUpload : 15 - numberOfUpload} Remaining
                Uploads
              </div>
            </div>
            ...
            <div className="pt-6 border-t border-gray-200 space-y-3">
              ...
              <p className="text-sm text-gray-500">
                This will permanently delete your profile and remove you from
                all workspaces.
              </p>
              <button
